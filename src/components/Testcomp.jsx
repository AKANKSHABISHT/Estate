  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80 mx-auto">
        Crafting Spaces, Builing Legacies-Explore Our Portfplio
      </p>
     ...
     transform: `translateX(-${currentIndex *100 }%)` 
        ...
        >
          {projectsData.map((project, index) => (
            <div
              key={index}
            //   className="relative flex-shrink-0 w-full sm:w-1/4 mr-8 last:mr-0"
            className={`relative flex-shrink-0 w-full ${cardsToShow > 1 ? "sm:w-1/4" : "w-full"} mr-8 last:mr-0`}
            >
              <img
                src={project.image}
                alt={project.title}
